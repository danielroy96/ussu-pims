...
function generateExpirationLabel(patInDate) {
    var expirationLabel;
    if (patInDate) {
        expirationLabel = ' <span class="label label-success">In date</span>';
    }
    else if (!patInDate) {
        expirationLabel = ' <span class="label label-danger">Expired</span>';
    }
    else expirationLabel = '';
