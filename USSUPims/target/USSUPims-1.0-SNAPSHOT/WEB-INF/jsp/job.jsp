        ...
        <div class="container welcome-bar">
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <h1><small>Equipment on the event</small></h1>
                    <hr>
                </div>
            </div>
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    <button id="btnCheckInOut" class="btn btn-primary btn-fullwidth" onclick="checkInOutItem();">Check out</button>
                </div>
                <div class="form-group col-md-3">
                    <button id="btnSwapCheckInOut" class="btn btn-secondary btn-fullwidth" onclick="switchCheckInOut();">Switch to check in</button>
                </div>
            </div>
        </div>
